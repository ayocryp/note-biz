// import { siteEnv } from "../config/baseUrl.js";

const siteEnv ='https://lur-api.deltechverse.com';
// letusrecon login
export const ADMIN_LOGIN = `${siteEnv}/v1/auth/admin/login`;
export const ADMIN_LOGOUT = `${siteEnv}/v1/auth/user/logout`;

// other endpoints

export const users_all = `${siteEnv}/v1/admin/users`;
export const users_me = `${siteEnv}/v1/users/me`;
export const PLANS = `${siteEnv}/v1/plans`;
export const plans_patch =`${siteEnv}/v1/admin/plans/`;
export const promo_codes =`${siteEnv}/v1/admin/promo-codes`;
export const promo_active =`${siteEnv}/v1/admin/promo-codes/active`;
export const settings =`${siteEnv}/v1/settings`;
export const settings_grouped =`${siteEnv}/v1/settings/grouped`;
export const settings_one =`${siteEnv}/v1/settings/`;
export const tools =`${siteEnv}/v1/admin/tools`;
