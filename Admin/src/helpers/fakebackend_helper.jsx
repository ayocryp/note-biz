...
const adminLogin = data => post(url.ADMIN_LOGIN, data);

  // get plans
export const getPlansApi = () => get(url.PLANS);

  // update plan
  export const updatePlanApi = plan => patch(url.PLANS, plan);
  
  // get plan detail
  export const getPlanDetailApi = id => get(`${url.plans}/${id}`, { params: { id } });
  
  // delete plan
  export const deletePlanApi = plan => del(url.plans, { headers: { plan } });
